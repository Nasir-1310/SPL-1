...
void mechanics()
{
    ...
    if(check==1)
    {
        ...
        /* char projectileAngle[20];
         double printalpha=30.8;
            sprintf(projectileAngle, "%.1f°", printalpha);
            */
...
swapbuffers();
outtextxy(20,70,"Description");
outtextxy(20,90,"m1=Mass of 1st object");
outtextxy(20,110,"m2=Mass of 2nd object");
outtextxy(20,130,"u1=initial velocity of 1st object");
outtextxy(20,150,"u2=initial velocity of 2nd object");
outtextxy(20,170,"v1=Final velocity of 1st object");
outtextxy(20,190,"v2=Final velocity of 2nd object");
line(490,70,490,210);
